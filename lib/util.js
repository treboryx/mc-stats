      ...
      if (type === "HERO") { //SG:heros 
        fetch(`http://api.hivemc.com/v1/player/${username}/HERO`)
          ...
          .then(async body => {
            ...
            Object.assign(data.HERO, { total_points, victories, kills, deaths, one_vs_one_wins, games_played, death_matches, tnt_used, crates_opened, food_consumed, first_game, last_game, achievements });
            resolve(data);
          });
      }
