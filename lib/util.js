...
module.exports = {
  ...
  hivemc: (username, type) => { // Incomplete 
    return new Promise((resolve, reject) => {
      ...
      if (type === "SG") { //Survival games 1
        fetch(`http://api.hivemc.com/v1/player/${username}/SG`)
          ...
          .then(async body => {
            ...
            Object.assign(data.SG, { victories, total_points, most_points, games_played, chest_opens, chest_opens, death_matches, kills, deaths, time_alive, first_win, achievements, last_game });
            resolve(data);
          });
      }
      ...
      if (type === "CAI") { //Cowboys and Indians
        fetch(`http://api.hivemc.com/v1/player/${username}/CAI`)
          ...
          .then(async body => {
            ...
            Object.assign(data.CAI, { total_points, captured, captures, catches, caught, games_played, victories, first_game, title, first_game, last_game });
            resolve(data);
          });
      }
      if (type === "CR") { //Cranked
